...
${BUILD}/game_moves.o: ${SRC}/game.h ${SRC}/types.h ${SRC}/game_moves.cpp
	$(CC) $(CPPFLAGS) -c ${SRC}/game_moves.cpp -o $@

${BUILD}/game_make_move.o: ${SRC}/game.h ${SRC}/types.h ${SRC}/game_make_move.cpp
	$(CC) $(CPPFLAGS) -c ${SRC}/game_make_move.cpp -o $@

${BUILD}/game_piece_moves.o: ${SRC}/game.h ${SRC}/types.h ${SRC}/game_piece_moves.cpp
